    ...
    suite('GET', function() {
      ...
      test('Ten most recently bumped threads (<= 3 most recent replies each )', function(done) {
        ...
        .end(function(err, res){
          ...
          assert.notProperty(res.body[0], 'delete_password', 'Returned thread should NOT include \'delete_password\' property.');
          assert.notProperty(res.body[0], 'reported', 'Returned thread should NOT include \'reported\' property.');
    ...
    suite('GET', function() {
      ...
      test('GET an entire thread with all its replies.', function(done) {
        ...
        .end(function(err, res){
          ...
          assert.notProperty(res.body, 'delete_password', 'Returned thread should NOT include \'delete_password\' property.');
          assert.notProperty(res.body, 'reported', 'Returned thread should NOT include \'reported\' property.');
          assert.isArray(res.body.replies, '\'replies\' property should be an array.');
          assert.property(res.body.replies[0], '_id', 'Thread should include \'_id\' property.');
          assert.property(res.body.replies[0], 'text', 'Thread should include \'text\' property.');
          assert.property(res.body.replies[0], 'created_on', 'Thread should include \'created_on\' property.');
          assert.notProperty(res.body.replies[0], 'delete_password', 'Returned thread should NOT include \'delete_password\' property.');
          assert.notProperty(res.body.replies[0], 'reported', 'Returned thread should NOT include \'reported\' property.');
